...
pdftitle={S3_Report},
pdfsubject={Lab session 3: Control of a three-phase inverter connected to the grid},
pdfkeywords={},
...
\thesistitle{Lab session 3: Control of a three-phase inverter connected to the grid}
\author{Ricard Lado Roigé}
\submitdate{November 14th 2019}
%\copyrightyear{2019}  % if date omitted, current year is used.
%%%%%%%%%%%%%%%%%%%%%   end titlepage info  %%%%%%%%%%%%%%%%%%%%%%
