...
pdftitle={S2_Report},
pdfsubject={Lab session 2: Control of a three-phase inverter connected to the grid},
pdfkeywords={},
...
\thesistitle{Lab session 2: Control of a three-phase inverter connected to the grid}
